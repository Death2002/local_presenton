      ...
      {modelsChecked && models.length === 0 && (
        <div className="mb-4 rounded-lg border border-yellow-200 bg-yellow-50 p-3">
          <p className="text-sm text-yellow-800">
            No models returned from the endpoint. This may mean your API key is invalid, the server could not be reached, or the <code className="rounded bg-yellow-100 px-1 py-0.5 text-xs">/v1/models</code> endpoint is not supported. Enter the model ID manually below.
          </p>
        </div>
      )}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              type="text"
              required
              placeholder="e.g. FLUX.1-dev, dall-e-3, gpt-image-1"
              className="w-full rounded-lg border border-gray-300 px-4 py-2.5 outline-none transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              value={model}
